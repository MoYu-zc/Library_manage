...
public class People_purchase_new_View extends JPanel implements ActionListener {
	//定义标签  标题，公司名称，负责人，性别，电话，地址
	private JLabel bt,name,people,sex,tel,address;
	//定义文本框  公司名称，负责人，性别，电话，地址
	private JTextField Name,People,Sex,Tel,Address;
	//定义按钮
	...
	public People_purchase_new_View(){
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==submit){
			...
			Boolean b=A.Check_Purchase(Name.getText());
			if(b){
				JOptionPane.showMessageDialog(this,"该采购商已存在！");
				Name.setText("");
				People.setText("");
				Tel.setText("");
				Address.setText("");
			}else{
			A.AddPuechase(Name.getText(), People.getText(), (String)SEX.getSelectedItem(), Tel.getText(), Address.getText());
